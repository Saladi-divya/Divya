    ...
    class Program
    {
        static void Main(string[] args)
        {
            List<student> students = new List<student>() {
             new student(){firstname="Divya",lastname="Saladi",smailid="sdivyasree999@gmail.com",branch="EEE",percentage=87,subintrest= new List<string>{ "Power sys", "CONTROL engineering " } },
